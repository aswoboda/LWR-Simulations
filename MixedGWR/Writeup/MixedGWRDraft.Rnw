...
<<regression01>>=
mylogit <- glm(cbind(B0rank, 1-B0rank) ~ samplesize + metric + B0sv + B1sv + B2sv + error + ModelBeta0svTrue, 
data = rankData, family = "binomial")
summary(mylogit)
@
...
How are the various parameters related to the results of the $\beta _1$ ranking?
<<regression11>>=
mylogit <- glm(cbind(B1rank, 1-B1rank) ~ samplesize + metric + B0sv + B1sv + B2sv + error + ModelBeta1svTrue, 
data = rankData, family = "binomial")
summary(mylogit)
@
...
How are the various parameters related to the results of the $\beta _2$ ranking?
<<regression21>>=
mylogit <- glm(cbind(B2rank, 1-B2rank) ~ samplesize + metric + B0sv + B1sv + B2sv + error + ModelBeta2svTrue, 
data = rankData, family = "binomial")
summary(mylogit)
@
...
<<regression02>>=
mylogit <- glm(cbind(B0rank, 1-B0rank) ~ samplesize + metric + B0sv + B1sv + B2sv + error + ModelBeta0svTrue+ ModelBeta1svTrue+ ModelBeta2svTrue, 
               data = rankData, family = "binomial")
summary(mylogit)
@
...
How are the various parameters related to the results of the $\beta _1$ ranking?
<<regression12>>=
mylogit <- glm(cbind(B1rank, 1-B1rank) ~ samplesize + metric + B0sv + B1sv + B2sv + error + ModelBeta0svTrue+ ModelBeta1svTrue+ ModelBeta2svTrue, 
               data = rankData, family = "binomial")
summary(mylogit)
@
...
How are the various parameters related to the results of the $\beta _2$ ranking?
<<regression22>>=
mylogit <- glm(cbind(B2rank, 1-B2rank) ~ samplesize + metric + B0sv + B1sv + B2sv + error + ModelBeta0svTrue+ ModelBeta1svTrue+ ModelBeta2svTrue, 
               data = rankData, family = "binomial")
summary(mylogit)
@

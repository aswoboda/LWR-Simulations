...
<<betaSpVar, echo = FALSE, results='hide'>>=
...
<<ModelBandwidthSelectionLLL, echo=FALSE, results ='hide'>>=
...
<<ModelSelectionGGGtoLLL, echo = FALSE, results = 'hide'>>=
...
<<ModelSelectionTabulations1G, echo = FALSE, results='hide'>>= 
#, fig.height=14, fig.width=10>>=
...
<<ModelSelectionTabulationsAll8, echo = FALSE, results='hide'>>= 
#, fig.height=14, fig.width=10>>=
...
<<ModelAndBandwidthByMetric, echo = FALSE, results='hide'>>=

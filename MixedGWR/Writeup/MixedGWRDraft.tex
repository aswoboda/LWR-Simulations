...
\end{equation}
where $i$ denotes the observation, $N$ is the sample size, and $m \in \{0, 1, 2\}$ specifies the model coefficient in question.

\begin{table}[ht]
\caption{Here is my Title}
\centering
\begin{tabular}{crccc}
